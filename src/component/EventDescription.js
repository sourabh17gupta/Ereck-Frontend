...
const EventDescription = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 pb-14 px-4 sm:px-6 lg:px-20">
      ...
      {/* UPPER SECTION — IMAGE LEFT / DESCRIPTION RIGHT */}
      <div className="fade-up grid grid-cols-1 lg:grid-cols-2 gap-4 items-start mb-6 max-w-[1050px] mx-auto">
        ...
        <div className="order-2 max-w-[550px] lg:pl-4">
      ...
      {event.galleryImages?.length > 0 && (
        <>
          {/* Perfectly aligned with upper section */}
